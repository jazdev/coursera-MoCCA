...
public class CreateStoryActivity extends StoryActivityBase {
	...
	private void launchSoundIntent() {
		...
		i.putExtra(SoundRecordActivity.EXTRA_OUTPUT, f.getAbsolutePath());
	...
	private void launchCameraIntent() {
		...
		Uri fu = getOutputMediaFileUri(MEDIA_TYPE_IMAGE);
		fragment.imagePath = fu;
		// TODO - Add the filename to the Intent as an extra. Use the
		// Intent-extra name
		// from the MediaStore class, EXTRA_OUTPUT
		i.putExtra(MediaStore.EXTRA_OUTPUT, fu);
	...
	private void launchVideoCameraIntent() {
		...
		Uri fu = getOutputMediaFileUri(MEDIA_TYPE_VIDEO);
