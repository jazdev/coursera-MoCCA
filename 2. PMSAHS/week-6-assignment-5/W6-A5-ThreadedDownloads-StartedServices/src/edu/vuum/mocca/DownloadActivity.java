...
public class DownloadActivity extends DownloadBase {
	...
	static class MessengerHandler extends Handler {
		...
		public void handleMessage(Message msg) {
			...
			if (activity != null) {
				...
				// activity.displayBitmap(msg.toString());
	...
	public void runService(View view) {
		...
		case R.id.intent_service_button:
			...
			Intent in = DownloadIntentService.makeIntent(this, handler,
					getUrlString());
			startService(in);
		...
		case R.id.thread_pool_button:
			...
			// returned from the makeIntent() factory method.
			// ThreadPoolDownloadService.makeIntent(this, handler,
			// getUrlString());
			Intent in2 = ThreadPoolDownloadService.makeIntent(this, handler,
					getUrlString());
			startService(in2);
